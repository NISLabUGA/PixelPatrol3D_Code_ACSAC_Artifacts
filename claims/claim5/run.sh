...
echo "=========================================="
echo ""
echo "This is an adversarial training verification test case. "
echo "It purpose is to test that the training process works correctly."
echo "It is NOT intended to be run all the way to completion."
echo ""
echo "Target Model: artifacts/models/rq1_rq4/m_ep4.pth"
echo "Selected Epoch: 4 (best performance on validation data)"
echo ""
echo "Expected Runtime: ~1 hour on V100 32GB GPU (~15 min/epoch)"
...
echo "Command: python3 tt_comb.py --epochs 4 --batch_size 32"
echo ""

# Run training verification with limited epochs and smaller batch size for verification
python3 tt_comb.py --epochs 4 --batch_size 32
...
echo "python3 tt_comb.py --epochs 4"
echo "(Expected time: ~1 hour on V100 32GB GPU)"
echo ""
