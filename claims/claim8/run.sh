...
echo "=========================================="
echo ""
echo "This is an l1o training verification test case. "
echo "It purpose is to test that the l1o training process works correctly."
...
echo ""
echo "Expected Runtime: ~8.5 hours on V100 32GB GPU (~5 min/epoch, 10 campaigns)"
...
echo "- m_camp_1_ep10.pth → Campaign 1 held out (epoch 10)"
echo "- m_camp_2_ep3.pth → Campaign 2 held out (epoch 3)"
echo "- m_camp_3_ep3.pth → Campaign 3 held out (epoch 3)"
echo "- m_camp_4_ep4.pth → Campaign 4 held out (epoch 4)"
echo "- m_camp_5_ep5.pth → Campaign 5 held out (epoch 5)"
echo "- m_camp_6_ep10.pth → Campaign 6 held out (epoch 10)"
echo "- m_camp_7_ep4.pth → Campaign 7 held out (epoch 4)"
echo "- m_camp_8_ep2.pth → Campaign 8 held out (epoch 2)"
echo "- m_camp_9_ep4.pth → Campaign 9 held out (epoch 4)"
echo "- m_camp_10_ep7.pth → Campaign 10 held out (epoch 7)"
echo ""
echo "Epoch Variation Insights:"
echo "- Fast converging campaigns: Converge quickly (epochs 2-4)"
echo "- Moderate converging campaigns: Standard training (epochs 5-7)"
echo "- Slow converging campaigns: Require more training (epochs 8-10)"
...
echo "(Expected time: ~8.5 hours total on V100 32GB GPU)"
echo ""
