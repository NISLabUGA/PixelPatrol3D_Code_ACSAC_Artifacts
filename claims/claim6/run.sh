...
echo "It purpose is to test that the adversarial training process works correctly."
...
echo ""
echo "Expected Runtime: ~5.25 hours on V100 32GB GPU (~45 min/epoch)"
...
echo "python3 tt_comb_adv.py --epochs 7"
echo "(Expected time: ~5.25 hours on V100 32GB GPU)"
echo ""
